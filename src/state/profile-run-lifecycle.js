...
function profileBuildRunSummary(outcome) {
  ...
  return {
    ...
    matingGoal: 5,
    lineageStageId: (player.lineage && player.lineage.currentStageId) || "purgatorius",
    lineageStageName: (player.lineage && typeof getLineageStage === "function" && getLineageStage(player.lineage.currentStageId)) ? getLineageStage(player.lineage.currentStageId).displayName : "Purgatorius",
    completedLineageStages: (player.lineage && Array.isArray(player.lineage.completedStages)) ? player.lineage.completedStages.slice() : [],
